		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comdocproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdocproject1-display": {
								"semanticObject": "comdocproject1",
								"action": "display",
								"description": "An SAP Fiori application for Doctor Appointment",
								"title": "Doctor Appointment",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.doc.project1",
									"url": sap.ui.require.toUrl("com/doc/project1")
								}
							}
						}
					}
